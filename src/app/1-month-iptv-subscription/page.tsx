              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed text-text-secondary">
                    This guide focuses on the trial-to-paid handoff — when to renew monthly, when to
                    upgrade quarterly, and how to spot providers that don&apos;t deserve a paid month.
                    Pricing, channel counts, uptime, and refund policy are verified against IPTV
                    UPG&apos;s internal monitoring and customer-support records before publication.
