...
export const COUNTRY_PAGES: CountryDetail[] = [
  {
    ...
    intro:
      "The average US household spends $147 a month on cable, broadband, and two streaming services combined. IPTV UPG replaces the cable line item. The full broadcast network stack in 4K, regional sports networks, the premium movie tier, and the cable-replacement entertainment package ship on one login at $7.50 a month. The 7-day on-screen guide makes the TV behave the way the cable box used to.",
    channelHighlights:
  ...
  },
  {
    ...
    intro:
      "Dutch TV runs across NPO, RTL Group, and Talpa Network, with Eredivisie rights on ESPN NL and Champions League on RTL or Ziggo. IPTV UPG carries NPO 1/2/3, the RTL channels, SBS6, Net5, Veronica, Talpa channels, ESPN NL with full Eredivisie, plus Ziggo Sport — one login, no Ziggo subscription required.",
    channelHighlights:
  ...
  },
  {
    ...
    intro:
      "Süper Lig football rights moved between Digiturk and beIN Connect Turkey for years; IPTV UPG carries the current beIN Sports HD Turkey tier alongside TRT 1, Show TV, Star TV, Kanal D, ATV, FOX Türkiye, and the full Turkish news and entertainment lineup — one login, no Digiturk subscription required.",
    channelHighlights:
